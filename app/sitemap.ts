...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${BASE}/guides/100k-salary-after-tax`, lastModified: now, priority: 0.6 },
    { url: `${BASE}/guides/debt-avalanche-vs-snowball`, lastModified: now, priority: 0.6 },
    { url: `${BASE}/guides/debt-to-income-ratio`, lastModified: now, priority: 0.6 },
    ...
    { url: `${BASE}/guides/how-much-should-i-save`, lastModified: now, priority: 0.6 },
    ...
    { url: `${BASE}/guides/how-to-build-wealth`, lastModified: now, priority: 0.6 },
    ...
    { url: `${BASE}/guides/how-to-save-money`, lastModified: now, priority: 0.6 },
    ...
    { url: `${BASE}/guides/sp500-investment-calculator`, lastModified: now, priority: 0.6 },
    { url: `${BASE}/guides/understanding-mortgage-rates`, lastModified: now, priority: 0.6 },
    { url: `${BASE}/guides/understanding-tax-brackets`, lastModified: now, priority: 0.6 },
    ...
    { url: `${BASE}/privacy/stack-tower`, lastModified: now, priority: 0.2 },
  ];
